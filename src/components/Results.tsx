...
const Results = () => {
  ...
  return <section className="py-20 bg-gradient-to-b from-white to-nude-soft">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-16 animate-on-scroll">
          <Carousel className="w-full max-w-5xl mx-auto">
            <CarouselContent>
              {beforeAfterImages.map((item, index) => <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                  <div className="bg-white rounded-3xl p-6 shadow-lg hover-lift border border-rose-light/20 h-full">
                    <div className="relative mb-4 overflow-hidden rounded-2xl">
                      <img src={item.image} alt={item.alt} className="w-full h-48 sm:h-56 md:h-64 object-cover transition-transform duration-300 hover:scale-105" loading="lazy" />
        ...
        <div className="text-center animate-on-scroll">
          <div className="bg-gradient-to-br from-rose-light/20 to-nude-soft/50 rounded-3xl p-8 border border-rose-light/30">
            ...
            <a href="https://wa.me/5513996631392" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-rose-burnt text-white px-8 py-4 rounded-full font-semibold hover-lift shadow-lg hover:bg-rose-burnt/90 transition-all" aria-label="Iniciar minha transformação via WhatsApp">
